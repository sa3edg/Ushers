		...
		<div class="body">
			<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_SUPER_USER', 'ROLE_USHER', 'ROLE_DATAENTRY')">
				<div style="text-align: center; padding: 30px; width: 850px;">
					<form:form method="post" action="addProjectLocation" modelAttribute="ProjectLocation">
						...
						<table>
							...
							<tr>
                            	<td><form:label path="locationType"><spring:message code="project.locations.type"/></form:label><span class="required"/></td>
                            	<td><form:select path="locationType" items="${types}"/></td>
                            </tr>
							<tr>
